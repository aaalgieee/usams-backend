...
class Activity(Base):
    ...
    datetime_approved = sqlalchemy.Column(sqlalchemy.DateTime)
    disapproved_by = sqlalchemy.Column(sqlalchemy.Integer, sqlalchemy.ForeignKey("account.account_id"))
    disapproval_remarks = sqlalchemy.Column(sqlalchemy.Text)
    datetime_disapproved = sqlalchemy.Column(sqlalchemy.DateTime)
    datetime_created = sqlalchemy.Column(sqlalchemy.DateTime, nullable=False)
